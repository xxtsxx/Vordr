...
set SOURCES=main console hardening random loadcfg sha256 sha1 aesgcm blake2b argon2 fileio secmem vault totp tpm regcfg pwgen bench log selftest redteam gui
...
link /nologo /subsystem:windows /entry:wstart /nodefaultlib /incremental:no ^
     ...
     kernel32.lib bcrypt.lib user32.lib advapi32.lib comdlg32.lib ncrypt.lib shell32.lib
if errorlevel 1 goto :failed
