...
extern cmd_convcap:proc                 ; over-long value is refused, not stored empty (vault.asm)
...
cmd_table label CMDENT
    ...
    CMDENT { w_convcap,   cmd_convcap,   0, 0 }   ; over-long value refused, never stored empty
