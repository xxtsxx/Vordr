...
sn_mica dw 'M','i','c','a',0
sn_acrylic dw 'A','c','r','y','l','i','c',0
align 8
scheme_names dq sn_light,sn_sepia,sn_nord,sn_midnight,sn_commodore,sn_amethyst,sn_emerald,sn_sapphire,sn_gruvbox,sn_mica,sn_acrylic
GUI_SCHEME_COUNT equ 11
